...
entry.place(relx=0.2, rely=0.1, relheight=0.1, relwidth=0.6)
...
buton1.config(text="1", bg="black", fg="white", command=lambda: tıklanan_buton(
    1), borderwidth=10, font="verdana 12 bold")
buton1.place(relx=0.1, rely=0.3, relheight=0.1, relwidth=0.10)
